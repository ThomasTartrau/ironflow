...
## [2.37.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.36.4...ironflow-engine-v2.37.0) - 2026-09-21
...
## [2.36.4](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.36.3...ironflow-engine-v2.36.4) - 2026-09-21

### Changed

- #95 typer fortement les events du bus (reprise manuelle)

## [2.36.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.35.5...ironflow-engine-v2.36.0) - 2026-09-18

### Added

- #88 add DecisionProvider and ctx.decision step

## [2.35.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.34.0...ironflow-engine-v2.35.0) - 2026-09-11

### Added

- #78 add template registry versioning and dependency management

## [2.34.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.33.2...ironflow-engine-v2.34.0) - 2026-09-11

### Added

- #76 S3 blob store, garbage collector and SHA-256 deduplication

## [2.33.2](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.33.1...ironflow-engine-v2.33.2) - 2026-09-10

### Changed

- #77 remove cron scheduling from ironflow-runtime

## [2.33.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.32.4...ironflow-engine-v2.33.0) - 2026-09-10

### Added

- #71 add delay step for timed workflow pauses

## [2.32.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.31.0...ironflow-engine-v2.32.0) - 2026-09-08

### Added

- #55 add ironflow-ops-gitlab crate powered by the gitlab crate

## [2.31.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.30.1...ironflow-engine-v2.31.0) - 2026-09-08
...
## [2.28.0](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.27.0...ironflow-engine-v2.28.0) - 2026-08-27

### Added

- #50 emit ApprovalRequired and AgentStepTokensUsed in WorkflowEventBus
...
- #43 add WorkflowEventBus for per-run real-time monitoring

## [2.24.1](https://gitlab.com/ThomasTartrau/ironflow/compare/ironflow-engine-v2.24.0...ironflow-engine-v2.24.1) - 2026-08-21

### Fixed

- #37 flaky duration_ms assertion in parallel cost test
