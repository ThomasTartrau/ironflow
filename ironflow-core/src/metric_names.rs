...
/// Counter: total input tokens served from the prompt cache (label: model).
pub const AGENT_TOKENS_CACHE_READ_TOTAL: &str = "ironflow_agent_tokens_cache_read_total";
/// Counter: total input tokens written to the prompt cache (label: model).
pub const AGENT_TOKENS_CACHE_WRITE_TOTAL: &str = "ironflow_agent_tokens_cache_write_total";
